...
public class PrintTicket1 extends JFrame
{
	public PrintTicket1(String sFrom, String sTo, String sClass, Integer iAdult, Integer iChildren, Integer iInfant, String sBookingDate, Integer iPrice, String sTime)
	{
		...
		JLabel LDemo = new JLabel("<html><U><font color=\"#8FBC8F\">AirLine-Project Developed By Mayank Gongal</font></U></html>");
...
//		JLabel LYugeshVerma = new JLabel("<html><I><font color=\"#8FBC8F\">Yugesh Verma</font></I></html>");
//		JLabel LGopiPal = new JLabel("<html><I><font color=\"#8FBC8F\">Gopi Pal</font></I></html>");
...
//
//		LYugeshVerma.setBounds(285, 565, 300, 20);
//		LGopiPal.setBounds(285, 585, 300, 20);
//		LNeeraj.setBounds(285, 605, 300, 20);
//		LSunil.setBounds(285, 625, 300, 20);
//
//		Panel2.add(LYugeshVerma);
//		Panel2.add(LGopiPal);
//		Panel2.add(LNeeraj);
//		Panel2.add(LSunil);
